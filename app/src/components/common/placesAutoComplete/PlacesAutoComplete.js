...
class PlacesAutocomplete extends Component {
  ...
  componentDidMount() {
    ...
    this.inputWidth = this.node.getBoundingClientRect().width;
    document.getElementById('PlacesAutocomplete__autocomplete-container').style.width = this.inputWidth + 'px';
  }
  ...
  handleInputChange(event) {
    ...
    this.autocompleteService.getPlacePredictions(
      { ...this.props.options, input: event.target.value }, debounce(this.autocompleteCallback, 50));
  }
  ...
  render() {
    ...
    return (
      <div
        ...
        <input {...inputProps} ref={node => { this.node = node; }}/>
          <div
            id="PlacesAutocomplete__autocomplete-container"
            style={!autocompleteItems || autocompleteItems.length === 0 ? 
              this.inlineStyleFor('autocompleteContainer', 'autocompleteContainerHidden') :
              this.inlineStyleFor('autocompleteContainer')}
            className={!autocompleteItems || autocompleteItems.length === 0 ?
              this.classNameFor('autocompleteContainer', 'autocompleteContainerHidden') :
              this.classNameFor('autocompleteContainer')}>
